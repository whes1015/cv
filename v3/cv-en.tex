%% Chen-Yu Kuo — resume (English)  [v3: adds employment history]
...
Sinica's Institute of Information Science, and now write software at the National Health Research Institutes.
\end{abstract}
...
%======================================================================
\begin{experiences}
  %% Entries without a description pack the whole range into the end-date slot:
  %% resume.cls only closes the table row when a description or tag list follows,
  %% so \experience[start]{end}{summary} alone would merge into the next row.
  \experience%
    {present\newline Jan 2025}%
