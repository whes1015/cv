...
%% 日期欄預設 6em = 60pt，而「2024 年 11 月」量起來是 60.44pt，會被硬拆成兩行。
%% 加寬 3pt 並從右欄扣回來，總寬不變，其餘版面不受影響。
\addtolength{\leftcolwidth}{3pt}
\addtolength{\rightcolwidth}{-3pt}
...
此外曾任衛波科技（P-Waver）後端工程師、中央研究院資訊科學研究所兼任助理，現於國家衛生研究院從事程式開發。
\end{abstract}
...
%======================================================================
\begin{experiences}
  %% 沒有描述的條目要把整段起訖日期塞進「結束日期」欄位：
  %% resume.cls 只有在後面接描述或標籤時才會收掉表格列，
  %% 單寫 \experience[起]{迄}{摘要} 會和下一列黏在一起。
  \experience%
    {現在\newline 2025 年 1 月}%
